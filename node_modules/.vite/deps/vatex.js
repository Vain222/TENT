...
// node_modules/vatex/node_modules/vue-demi/lib/index.mjs
var isVue2 = false;

// node_modules/vatex/dist/vatex.esm.js
var import_katex = __toESM(require_katex());
import "/home/q/TENT/node_modules/katex/dist/katex.min.css";
var i = (o, r = {}, n2) => {
  if (isVue2)
    return h(o, r, n2);
  const { props: i2, domProps: a2, on: s2, ...l2 } = r;
  const p = { ...l2, ...i2, ...a2, ...((e) => e ? Object.entries(e).reduce((e2, [t, o2]) => ({ ...e2, [t = `on${t = t.charAt(0).toUpperCase() + t.slice(1)}`]: o2 }), {}) : null)(s2) };
  return h(o, p, n2);
};
var a = defineComponent({ name: "VueLatex", props: { fontsize: { type: Number, default: 16 }, expression: { type: String, required: true }, displayMode: { type: Boolean, default: false }, throwOnError: { type: Boolean, default: false }, errorColor: { type: String, default: void 0 }, minRuleThickness: { type: Number, default: 0.04 }, macros: { type: Object, default: void 0 }, colorIsTextColor: { type: Boolean, default: void 0 }, maxSize: { type: Number, default: void 0 }, maxExpand: { type: Number, default: void 0 }, allowedProtocols: { type: Array, default: void 0 }, strict: { type: [Boolean, String, Function], default: void 0 } }, setup: (e) => ({ html: computed(() => import_katex.default.renderToString(e.expression, e)) }), render() {
  return i(this.displayMode ? "div" : "span", { domProps: { innerHTML: this.html }, style: { "font-size": `${this.fontsize}px` } });
} });
a.install = (e) => {
...
var l = { install: s };
var vatex_esm_default = l;
export {
  a as VueLatex,
  vatex_esm_default as default,
  s as install
};
//# sourceMappingURL=vatex.js.map
